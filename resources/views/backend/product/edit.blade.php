                            ...
                            <form action="{{route('product.update',$product->id)}}" method="post">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="number" value="{{$product->b_price}}" class="form-control" id="b_price" name="b_price" placeholder="update buying price per Item">
                                    <span class="error"><b>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{$product->price}}" class="form-control" id="price" name="price" placeholder="update selling  price pre Item">
                                    <span class="error"><b>
                                         @if($errors->has('price'))
                                                {{$errors->first('price')}}
                                            @endif</b></span>
