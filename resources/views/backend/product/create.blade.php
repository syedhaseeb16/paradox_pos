                            ...
                            <form action="{{route('product.store')}}" method="post">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="pb_rice" name="b_price" placeholder="Enter your buying price per Item">
                                    <span class="error"><b>
                                         @if($errors->has('price'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="price" name="price" placeholder="Enter your selling price per Item">
                                    <span class="error"><b>
                                         @if($errors->has('price'))
                                                {{$errors->first('price')}}
                                            @endif</b></span>
