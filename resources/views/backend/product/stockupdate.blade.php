                        ...
                        <div class="x_content">
                            <form action="{{route('stock.update',$product->id)}}" method="post">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label for="stock">Unit Price:(Buying)(suggested old price )</label>
                                    <input type="number" value="{{$product->b_price}}"  class="form-control" id="b_price" name="b_price" placeholder="Enter buying price" min="1">
                                    <span class="error"><b>
                                         @if($errors->has('b_price'))
                                                {{$errors->first('b_price')}}
                                         @endif</b></span>
                                </div>
                                <div class="form-group">
                                    <label for="stock">Unit Price:(Selling)</label>
                                    <input type="number" value="{{$product->price}}" class="form-control" id="price" name="price" placeholder="Enter selling price" min="1">
                                    <span class="error"><b>
                                         @if($errors->has('price'))
                                                {{$errors->first('price')}}
                                         @endif</b></span>
